...
MAIL_USERNAME = os.getenv("MAIL_USERNAME", "academyen222@gmail.com") # Reemplaza con tu correo
MAIL_PASSWORD = os.getenv("MAIL_PASSWORD", "atfk jpga xprn wspy") # Reemplaza con tu contraseña de aplicación de Gmail
...
async def send_test_email():
    recipient_email = "academyen222@gmail.com" # CAMBIA ESTO AL CORREO DESTINO
